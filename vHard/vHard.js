...
class Person{
    ...
    exercise(){
        console.log(`${this.name} is about to cross some people up when he goes to play basketball!`)
    }

    fetchJob(){
        console.log(`${this.name} is a ${this.job} at Red Ventures`)
    }
...
const isaacSantos = new Person ('Isaac Santos', 'Software Engineer', 18);
console.log(isaacSantos);
isaacSantos.exercise();
isaacSantos.fetchJob();

const santosIsaac = new Programmer('Isaac Santos', 'Software Engineer', 18, "Python, Javascript", "C++, Java")
console.log(santosIsaac);
santosIsaac.completeTask();
santosIsaac.offerNewTask();
santosIsaac.listLanuages();
santosIsaac.learnLanguages();